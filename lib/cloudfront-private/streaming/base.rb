			...
			module Base
				...
				module ClassMethods
				  ...
				  protected				
				    ...
				    def create_policy(_resource, _request,expire)
				      expires = expire.to_i || 1.hour.from_now.to_i 
